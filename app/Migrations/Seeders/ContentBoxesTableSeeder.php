    ...
    public function run()
    {
        ...
        DB::table('content_boxes')->insert([
            ...
            [
                ...
                'name' => 'Reality',
                'slug' => 'the_truth',
                'content' => '<p><strong>re·al·i·ty</strong> <em class="text-muted">rēˈalədē/</em></p>',
            ],
            [
                'page_id' => 2,
                'name' => 'Story Quote',
                'slug' => 'story_quote',
                'content' => 'We love each other <br>and that’s the beginning <br>and the ending of everything.',
            ],
            [
                'page_id' => 3,
            ...
            [
                ...
                'content' => '<p>Cocktails 5:30pm<br>Centre Communautaire Sarto-Desnoyers<br>1335 Chemin Bord-du-Lac, <br>Dorval, <br>QC H9S 2E5</p> <p class="map-link"><a href="https://maps.google.com/maps?ll=45.439893,-73.754426&amp;z=16&amp;t=m&amp;hl=en-US&amp;gl=CA&amp;mapclient=embed&amp;q=1335%20Lakeshore%20Dr%20Dorval%2C%20QC%20H9S%202E5">MAP</a></p>',
            ],
            [
                'page_id' => 5,
